...
<head> 
	...
	<title>Contas de Usuários - Unimed Volta Redonda</title>
		...
		<article>
			...
			<div class="row sidebar">
				...
				<div class="col-md-7 col-xs-6 pull-left">
					<a href="<?php echo base_url('admin/contas/inserir')?>" class="btn btn-primary">Inserir</a>
				</div>						
			...
			if($this->session->flashdata('error-self-account') != ''){
				echo '<div class="alert alert-danger">Você não pode remover sua própria conta.</div>';
			}
			?>
		...
		$(function(){
			...
			$('.remover').click(function(){
				...
				bootbox.confirm('Você está prestes a remover um registro.\n\nConfirma operação?', function(r){
					if(r){
						location.href = "<?php echo base_url('admin/contas/remover')?>/" + id;
					}
				});
			});
