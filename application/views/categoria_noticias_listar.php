...
<head>
	...
	<title>Categoria <?php echo $categoria->dcategoria?> - Unimed Volta Redonda</title>
...
<body>
	...
	<section class="container">
		...
		<header>
			<h1>Categoria: <?php echo $categoria->dcategoria?></h1>
		</header>
		...
		<article>
			...
			<div class="row sidebar">
				...
				<div class="col-md-6 col-xs-7 col-lg-5">
					<?php echo form_open('categorias/detalhar/' . $categoria->id_categoria)?>
