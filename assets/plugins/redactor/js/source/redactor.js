...
var RLANG = {
	...
	backcolor: 'Cor do Realce do Texto',
	unorderedlist: 'Marcadores',
	orderedlist: 'Numeração',
	...
	insert_row_above: 'Inserir Linhas Acima',
	insert_row_below: 'Inserir Linhas Abaixo',
	insert_column_left: 'Inserir Colunas à Esquerda',
	insert_column_right: 'Inserir Colunas à Direita',
	delete_column: 'Excluir Coluna Inteira',
	delete_row: 'Excluir Linha Inteira',
	delete_table: 'Excluir Tabela',
	rows: 'Linhas',
	columns: 'Colunas',
	add_head: 'Adicionar Cabeçalho',
	delete_head: 'Excluir Cabeçalho',
	title: 'Título',
	image_position: 'Posição',
	none: 'Nenhum',
	left: 'Esquerda',
	right: 'Direita',
	image_web_link: 'Colar o Link da Imagem',
	text: 'Texto',
	mailto: 'E-mail',
	web: 'URL',
	video_html_code: 'Código do vídeo',
	file: 'Inserir Arquivo',
	upload: 'Enviar',
	download: 'Baixar',
	choose: 'Selecionar',
	or_choose: 'Ou escolher',
	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			allowedTags: ["form", "input", "button", "select", "option", "datalist", "output", "textarea", "fieldset", "legend",
					...
					"big", "pre", "figure", "figcaption", "strong", "em", "table", "tr", "td",
			...
			colors: ['#FFFFFF', '#BFBFBF', '#3F3F3F', '#000000', '#16a085', '#27ae60', '#2980b9', '#8e44ad', '#f1c40f', '#f39c12', '#e67e22', '#e74c3c',],
			colors_name: ['Branco', 'Branco 30%', 'Preto 30%', 'Preto', 'Verde escuro', 'Verde', 'Azul', 'Roxo', 'Amarelo', 'Laranja', 'Laranja escuro', 'Vermelho'],
